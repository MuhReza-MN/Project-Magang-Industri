...
export default function AuthLayout({
  ...
  return (
    <div className="flex flex-col min-h-screen w-full bg-linear-to-tr overflow-x-hidden
      ...
      <div className="fixed flex grow inset-0 bg-linear-to-tr from-violet-200 via-violet-300 to-blue-200 -z-10" />
      <main className="flex grow justify-center items-center relative">{children}</main>
      <footer className="flex relative justify-center items-center h-[clamp(2.5rem,5vh,5rem)] font-bold text-[clamp(1rem,1.25vw,2rem)] text-shadow-md text-white
