...
export default function HomeClient() {
  ...
  return (
    <div className="min-h-screen contain-inline-size">
      ...
      <section
        id="hero"
        className="relative z-10 min-h-[100%] flex flex-col items-center"
      >
      ...
      <section id="event" className="relative z-10 mt-40 lg:mx-2">
        <div className="flex flex-col gap-2 items-center-safe justify-center">
          ...
          <div className="flex h-2 lg:h-2.5 w-[260px] md:w-[400px] lg:w-[500px]  rounded-3xl bg-gradient-to-r from-[#eb4b3f] to-[#f0945b]" />
        </div>
      ...
      <section
        id="about"
        className="relative z-10 mt-10 py-4 bg-black/70 flex flex-col lg:flex-row basis-full px-3 lg:px-10 sm:gap-5"
      >
...
function Arrow(props: { left?: boolean; onClick: (e: any) => void }) {
  return (
    <button
      ...
      className={`absolute top-1/2 z-20 -translate-y-1/2 lg:px-1 text-7xl md:text-9xl lg:text-9xl font-bold text-white/70 hover:text-white active:text-white transition-colors duration-100 active:duration-75 ${
        props.left ? "-left-0.5 md:left-40 lg:-left-2 " : "-right-0.5 md:right-40 lg:-right-2"
      }`}
    >
      {props.left ? "❮" : "❯"}
    </button>
