    ...
    <div className="min-h-screen contain-inline-size">
      ...
      <section className="relative z-10 min-h-screen flex flex-col items-center">
        ...
        <motion.div
          ...
          className="flex items-center flex-col mt-5 lg:mt-8"
        >
          <button
            type="button"
      ...
      <section className="relative z-10 mt-40 lg:mx-2">
        <div className="flex flex-col gap-2 items-center-safe justify-center">
          <motion.h2
            ...
            viewport={{ once: true, amount: 0.2 }}
            variants={flyVariants.up}
            className="text-5xl text-shadow-md text-center font-semibold mx-2 lg:mx-0"
          >
            ONGOING EVENT
          </motion.h2>
          <motion.div
            ...
            viewport={{ once: true, amount: 0.2 }}
            variants={flyVariants.up}
            className="flex h-2 lg:h-2.5 w-[260px] md:w-[400px] lg:w-[500px] rounded-3xl bg-black/10 overflow-hidden"
          >
            <motion.div
        ...
        <div className="navigation-wrapper relative mt-12 px-8 md:px-50 lg:px-15">
          <motion.div
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, amount: 0.2 }}
        ...
        <motion.p
          ...
          viewport={{ once: true, amount: 0.2 }}
          variants={flyVariants.up}
          className="pt-4 lg:pt-3 text-shadow-md font-semibold text-[15px] lg:text-2xl text-balance text-center px-2 lg:px-50"
        >
      ...
      <section className="relative z-10 mt-10 py-4 bg-black/70 flex flex-col lg:flex-row basis-full px-3 lg:px-10 sm:gap-5">
        <div className="flex flex-col gap-3 lg:w-[50%] pl-1 lg:pl-0">
          ...
          <motion.p
            ...
            viewport={{ once: true, amount: 0.2 }}
            variants={flyVariants.up}
            className="text-shadow-md lg:text-lg font-medium text-balance text-justify pr-2 lg:pr-20 "
          >
          ...
          <div className="flex flex-col justify-center items-center lg:items-start lg:gap-60 sm: gap-6">
            ...
            <div className="flex flex-col items-center lg:items-start gap-2">
              <motion.h3
                ...
                className="text-red-600 text-3xl text-shadow-md font-semibold tracking-widest"
              >
                CONTACT US
              </motion.h3>
              <motion.div
                ...
                viewport={{ once: true, amount: 0.2 }}
                variants={flyVariants.btn}
                className="flex flex-col md:flex-row lg:flex-row gap-3 lg:gap-5 px-8 mb-4 lg:mb-0"
              >
                <div className="flex lg:flex-col md:flex-row md:gap-2 items-center justify-start lg:justify-center pl-2 lg:pl-0 bg-gradient-to-r from-[#eb4b3f] to-[#f0945b] hover:brightness-90 active:brightness-90 transition-all duration-300 active:duration-25 w-60 h-15 md:w-65 md:h-18 lg:w-45 lg:h-45 ">
                  <FaWhatsapp className="text-[50px] md:text-[70px] lg:text-[100px] text-white" />
        ...
        <div className="flex flex-col gap-4 lg:gap-8 lg:w-[50%] md:w-[60%] sm:w-full px-2 lg:px-4 md:ml-[20.5%] lg:ml-0">
          <div className="flex flex-col lg:flex-row gap-4 lg:gap-8">
            <motion.div
              ...
              className="flex flex-row lg:flex-col lg:gap-1 items-center lg:items-center min-h-33 lg:min-h-100 w-full lg:w-80 bg-[#2d3751] rounded-2xl border-5 lg:border-12 border-[#5ce1e6]"
            >
              ...
              <div className="flex flex-col lg:gap-2 text-left lg:text-center">
                <h3 className="font-extrabold text-xl px-1 lg:px-10 whitespace-normal break-words leading-5">
          ...
          <div className="flex flex-col lg:flex-row gap-4 lg:gap-8">
            <motion.div
              ...
              className="flex flex-row lg:flex-col lg:gap-1 items-center lg:items-center min-h-43 lg:min-h-100 w-full lg:w-80 bg-[#2d3751] rounded-2xl border-5 lg:border-12 border-[#5ce1e6]"
            >
              ...
              <div className="flex flex-col gap-1 lg:gap-2 text-left lg:text-center">
                <h3 className="font-extrabold text-xl px-1 lg:px-4 whitespace-normal break-words leading-5 lg:leading-7">
                  Automatic Member{" "}
                  <span className="whitespace-nowrap">QR-code</span> Assign
                </h3>
                <h4 className="font-bold text-xs lg:text-sm text-balance text-justify lg:text-center px-1 pr-8 lg:pr-0">
            ...
            <motion.div
              ...
              viewport={{ once: true, amount: 0.2 }}
              variants={flyVariants.upD1}
              className="flex flex-row lg:flex-col lg:gap-4 items-center lg:items-center min-h-33 lg:min-h-100 w-full lg:w-80 bg-[#2d3751] rounded-2xl border-5 lg:border-12 border-[#5ce1e6]"
            >
      ...
      <section className="relative bg-gray-900 w-full z-10 pt-5 pb-10">
        <div className="flex flex-col gap-2 items-center-safe justify-center">
          <motion.h2
            ...
            viewport={{ once: true, amount: 0.2 }}
            variants={flyVariants.up}
            className="text-3xl lg:text-5xl text-shadow-md text-center font-semibold tracking-wide"
          >
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.2 }}
            variants={flyVariants.up}
            className="flex h-1.5 lg:h-2.5 mb-8 w-[300px] lg:w-[500px] rounded-3xl bg-white/20 overflow-hidden"
          >
            <motion.div
              variants={flyVariants.fill}
              className="h-full bg-gradient-to-r from-[#eb4b3f] to-[#f0945b] rounded-3xl"
          ...
          <div className="flex flex-col justify-center w-full md:px-40 sm:px-10 text-left">
            <motion.h3
              ...
              className="text-red-600 text-2xl text-shadow-md font-semibold pl-2 lg:pl-0"
            >
              Apa itu RQRE.ID ?
            </motion.h3>
            <motion.p
              ...
              viewport={{ once: true, amount: 0.2 }}
              variants={flyVariants.upD1}
              className="pl-4 pr-5 lg:pl-5 lg:pr-10 text-balance text-justify"
            >
            ...
            <motion.h3
              ...
              viewport={{ once: true, amount: 0.2 }}
              variants={flyVariants.left}
              className="text-red-600 text-2xl text-shadow-md mt-3 font-semibold pl-2 lg:pl-0"
            >
...
function Arrow(props: { left?: boolean; onClick: (e: any) => void }) {
  return (
    <motion.button
      ...
      className={`
        absolute top-1/2 z-20 -translate-y-1/2 lg:px-1 text-7xl md:text-9xl lg:text-9xl font-bold text-white/70 hover:text-white active:text-white 
        transition-colors duration-100 active:duration-75 
      ${
        props.left
          ? "-left-0.5 md:left-40 lg:-left-2 "
          : "-right-0.5 md:right-40 lg:-right-2"
      }`}
    >
      {props.left ? "❮" : "❯"}
    </motion.button>
