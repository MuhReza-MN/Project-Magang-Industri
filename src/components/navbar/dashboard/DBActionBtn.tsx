...
export default function ActionButtons({ onView, onEdit, onDelete, noView }: ActionBtnProps) {
  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        transition={{ duration: 0.1, ease: "easeInOut" }}
        className={`flex items-center justify-center overflow-hidden flex-row lg:flex-col lg:min-w-10
          bg-white border-[#00d27f] w-full select-none ${noView
            ? "border-y-2 border-l-2 border-r rounded-l-lg lg:rounded-r-none lg:rounded-tl-lg lg:rounded-bl-lg"
            : " border-y-2 border-x"}`}
